    ...
    <group ref={roomRef} name="room">
      ...
      <mesh position={[0, -roomHeight/2, 0]} receiveShadow>
        ...
        <meshStandardMaterial 
          ...
          roughness={0.8}
          metalness={0.1}
          // Wood texture effect with color variation
          map={null} // We'll add texture later if needed
        />
      </mesh>
      ...
      {/* Front Wall (partial - for camera view) */}
      {/* Left front wall section */}
      <mesh position={[-roomWidth/4, 0, roomDepth/2]} receiveShadow>
